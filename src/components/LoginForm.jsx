...
import { Eye, EyeOff, UserPlus, AlertCircle, ArrowLeft, LogIn } from 'lucide-react'
import {
  Card,
  CardContent,
  CardDescription,
...
const AuthForms = () => {
  ...
  const validateForm = () => {
    if (isLogin) {
      ...
      if (!formData.name || !formData.email || !formData.password || !formData.secret_code) {
        setError('All fields are required')
        return false
      }
    }
      ...
      <div className="w-full max-w-md space-y-4">
        <div className="text-center space-y-2 mb-8">
          ...
          <p className="text-gray-500">
            {isLogin ? 'Welcome back! Please log in to continue.' : 'Create your admin account'}
          </p>
        </div>
